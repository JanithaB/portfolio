...
export const SKILLS: Skill[] = [
  ...
  { 
    name: 'Arduino', 
    iconPath: 'M11.981 0C5.678 0 .5 5.178.5 11.481c0 5.197 3.158 9.643 7.643 11.488.279.103.636.22.915.22.279 0 .636-.117.915-.22C14.342 21.124 17.5 16.678 17.5 11.481 17.5 5.178 12.322 0 6.019 0h5.962zM6.019 2.5h5.962c4.97 0 9.019 4.049 9.019 9.019 0 4.412-3.294 8.206-7.643 9.643-.636.22-1.251.22-1.887 0C7.313 19.725 4.019 15.931 4.019 11.519c0-4.97 4.049-9.019 9.019-9.019z' 
  },
  { 
    name: 'Linux', 
    iconPath: 'M12.504 0c-.155 0-.315.008-.48.021-4.226.333-3.105 4.807-3.17 6.298-.076 1.092-.3 1.953-1.05 3.02-.885 1.066-1.583 2.525-1.583 4.244 0 1.127.698 2.056 1.583 4.244.885 1.188 1.05 1.928 1.05 3.02 0 .65.065 5.965 3.17 6.298.26.02.515.02.775.02 4.904 0 7.17-4.807 7.17-6.298 0-1.092.3-1.953 1.05-3.02.885-1.188 1.583-2.117 1.583-4.244 0-1.719-.698-3.178-1.583-4.244-.75-1.067-1.05-1.928-1.05-3.02.065-1.491-1.056-5.965-3.17-6.298C12.819.008 12.659 0 12.504 0zm-.87 2.093c.25-.02.5-.02.745-.02s.495 0 .745.02c2.542.2 2.542 3.214 2.542 4.427 0 .65-.08 1.17-.23 1.755-.08.325-.18.585-.18.975 0 .585.1 1.17.18 1.755.15.585.23 1.105.23 1.755 0 1.213 0 4.227-2.542 4.427-.25.02-.5.02-.745.02s-.495 0-.745-.02c-2.542-.2-2.542-3.214-2.542-4.427 0-.65.08-1.17.23-1.755.08-.325.18-.65.18-1.17 0-.52-.1-.845-.18-1.17-.15-.585-.23-1.105-.23-1.755 0-1.213 0-4.227 2.542-4.427z' 
  },
  { 
    name: 'MQTT', 
    iconPath: 'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.568 8.16c.6 0 1.08.48 1.08 1.08v5.52c0 .6-.48 1.08-1.08 1.08H6.432c-.6 0-1.08-.48-1.08-1.08V9.24c0-.6.48-1.08 1.08-1.08h11.136z' 
  },
  { 
    name: 'FastAPI', 
    iconPath: 'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2zm-1 4v12h2V6h-2zm6 0v12h2V6h-2zm-3 3v6h2V9h-2z' 
  },
  { 
    name: 'SQLite', 
    iconPath: 'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2zM8 6v12h8V6H8zm2 2h4v8h-4V8zm1 1v6h2V9h-2z' 
  },
  { 
    name: 'Spring Boot', 
    iconPath: 'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2zm-2 4v12h4V6h-4zm6 0v12h4V6h-4zm-3 3v6h2V9h-2z' 
  },
  { 
    name: 'TensorFlow', 
    iconPath: 'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2zM6 6v12h2V6H6zm10 0v12h2V6h-2zM9 9v6h6V9H9zm1 1h4v4h-4v-4z' 
  },
  { 
    name: 'Keras', 
    iconPath: 'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2zM7 6v12h2V6H7zm8 0v12h2V6h-2zM9 9h6v6H9V9zm1 1v4h4v-4h-4z' 
  },
];
